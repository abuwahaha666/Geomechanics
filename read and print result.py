...
input_file = 'G:/My Drive/Paper submission 2024/Field test and numerical simulation/Cut/different sides/two layers/Cut_CB_confined.post.res'################################################
# input_file = 'G:/My Drive/Paper submission 2024/Field test and numerical simulation/Cut_BBM/Cut_CB_confined.post.res'
    ...
    for i, line in enumerate(lines):
        if search_line in line:
            ...
            if step == j:
                ...
                for line in lines[start_index + 2:start_index + 2440]:  # Skip the header lines 5480 for wide model##########################################
    ...
    for i, line in enumerate(lines):
        if search_line in line:
            ...
            if step == j:
                start_index = i
                # Extract data after the identified line
                for line in lines[start_index + 2:start_index + 2337]:  # Skip the header lines 5297 for wide model#####################################
                    # Split each line by whitespace to extract node number and x, y values
                    parts = line.split()
...
nodes_of_interest = [2357, 1945, 1504, 901] #for the confined model 2393
...
times_to_plot = [50, 79, 113, 143, 171]
plt.rcParams['font.family'] = 'Times New Roman'
plt.rcParams['font.size'] = 10.5
